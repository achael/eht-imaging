...
Includes smoke tests for geometric models (every mring variant, model-parameter
dispatch including the unrecognized-type branch).
...
# ---------------------------------------------------------------------------
# Geometric-model smoke tests (mring variants + model-parameter dispatch)
# ---------------------------------------------------------------------------
