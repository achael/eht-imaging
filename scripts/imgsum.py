...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "inputobs_uncal",
        help='/path/to/uvfits_uncalibrated.uvfits')

    parser.add_argument('--c', '-c', type=str, default=" ",
                        help="comments for top of sheet")
    parser.add_argument(
        '--o',
        '-o',
        type=str,
    ...
    parser.add_argument(
        ...
        type=float,
        default=0,
        help="uv_min for closure phases")
    parser.add_argument(
        '--aipscc',
        type=bool,
        default=False,
        help="load clean components from fits")
    parser.add_argument(
        '--systematic_noise',
        type=float,
        default=0,
        help="systematic noise to add on amplitudes")
    parser.add_argument('--snrcut', type=float, default=0, help="snr cut")
    parser.add_argument(
        '--systematic_cphase_noise',
        type=float,
        default=0,
        help="systematic noise to add on cphase")
    parser.add_argument('--fontsize', type=int, default=0, help="font size")
    parser.add_argument(
        '--cfun',
        type=str,
        default='afmhot',
        help="image color function")
    parser.add_argument(
        '--no_ebar',
        default=False,
        action='store_true',
        help="remove ebars from amp")
    parser.add_argument(
        '--no_debias',
        default=False,
        action='store_true',
        help="don't debias amplitudes/closure amplitudes")
    parser.add_argument(
        '--no_gains',
        default=False,
        action='store_true',
        help="remove gain plots")
    parser.add_argument(
        '--no_cphase',
        default=False,
        action='store_true',
        help="remove closure phase plots")
    parser.add_argument(
        '--no_camp',
        default=False,
        action='store_true',
        help="remove closure amp plots")
    parser.add_argument(
        '--no_amp',
        default=False,
        action='store_true',
    ...
    kwargs = {
        ...
        'cfun': opt.cfun,
        'snrcut': snrcut,
        'sysnoise': opt.systematic_noise,
        'syscnoise': opt.systematic_cphase_noise,
        'fontsize': opt.fontsize,
        'gainplots': gainplots,
        'cphaseplots': cphaseplots,
        'campplots': campplots,
        'ampplots': ampplots,
        'debias': debias,
        'cp_uv_min': cp_uv_min}
