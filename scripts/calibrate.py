...
parser.add_argument(
    ...
    default=7.0,
    type=float,
    help="amplitude at zero-baseline")
parser.add_argument(
    '-t',
    '--tavg',
    default=10.0,
...
if args.output is None:
    # Automatically determine the output filename with the (e.g.,)
    # .polcal.uvfits step identifier stripped off
...
sites = {'AA', 'AP'}
[obs_cal_avg, master_caltab] = multical(
    obs_cal_avg, sites, master_caltab, n=2, amp0=args.ampzbl, gain_tol=0.3)
...
sites = {'AA', 'AP', 'SM', 'JC'}
[obs_cal_avg, master_caltab] = multical(
    obs_cal_avg, sites, master_caltab, n=2, amp0=args.ampzbl, gain_tol=0.1)
