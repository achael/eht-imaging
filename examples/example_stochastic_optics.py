...
total_flux = 3.4  # Jy
im = eh.image.Image(np.zeros((npix, npix)), fov /
                    npix, eh.RA_DEFAULT, eh.DEC_DEFAULT, rf=86e9)
...
gaussprior = gaussprior.add_gauss(
    total_flux, (prior_fwhm, prior_fwhm, 0, 0, 0))
...
# Now look at the unscattered image, the scattered image, and replicate
# the scattering using the solved screen
...
# Decrease the scattering regularization slightly and re-image (desired
# max |Epsilon| is ~2.5)
