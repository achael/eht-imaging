...
# The matplotlib windows may not open/close properly if you run this
...
# ampcal and phasecal determine if gain variations and phase errors are
# included
tint_sec = 5
tadv_sec = 600
tstart_hr = 0
