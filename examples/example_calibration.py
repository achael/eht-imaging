...
obs_nc = eh.calibrating.network_cal.network_cal(obs, im.total_flux(), processes=-1)
...
obs_nc = eh.calibrating.network_cal.network_cal(obs, im.total_flux(), processes=0)
