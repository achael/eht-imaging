...
The latest stable version (`1.3.2 <https://github.com/achael/eht-imaging/releases/tag/v1.3.2>`_) is available on `PyPi <https://pypi.org/project/ehtim/>`_. Simply install pip and run
