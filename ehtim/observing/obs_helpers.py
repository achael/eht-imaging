...
def merr(sigma, qsigma, usigma, I, m):
    """Return the error in fractional polarization real and imaginary parts given stokes input
    """
...
def merr2(rlsigma, rrsigma, llsigma, I, m):
    """Return the error in fractional polarization real and imaginary parts given polprod input
    """
